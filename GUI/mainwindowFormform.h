...
public:
    ...
    QAction *actionBandPass;
    QAction *actionNotch;
    QAction *actionPeaking;
    QAction *actionLowShelf;
    QAction *actionHighShelf;
    QAction *actionRate;
    QAction *actionPitch;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icon/MusicMonster.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        actionHighPass->setObjectName(QString::fromUtf8("actionHighPass"));
        actionLowPass = new QAction(MainWindow);
        actionLowPass->setObjectName(QString::fromUtf8("actionLowPass"));
        actionBandPass = new QAction(MainWindow);
        actionBandPass->setObjectName(QString::fromUtf8("actionBandPass"));
        actionNotch = new QAction(MainWindow);
        actionNotch->setObjectName(QString::fromUtf8("actionNotch"));
        actionPeaking = new QAction(MainWindow);
        actionPeaking->setObjectName(QString::fromUtf8("actionPeaking"));
        actionLowShelf = new QAction(MainWindow);
        actionLowShelf->setObjectName(QString::fromUtf8("actionLowShelf"));
        actionHighShelf = new QAction(MainWindow);
        actionHighShelf->setObjectName(QString::fromUtf8("actionHighShelf"));
        actionRate = new QAction(MainWindow);
        actionRate->setObjectName(QString::fromUtf8("actionRate"));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icon/openFile.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icon/newFile.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icon/importFile.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icon/delete.jpg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icon/waveform!.png"), QSize(), QIcon::Normal, QIcon::Off);
        waveform->setIcon(icon5);
        ...
        waveWidget = new WavWidget(mainWidget);
        waveWidget->setObjectName(QString::fromUtf8("waveWidget"));

        gridLayout->addWidget(waveWidget, 1, 0, 1, 1);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icon/playloop.png"), QSize(), QIcon::Normal, QIcon::Off);
        playloop->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icon/stop.png"), QSize(), QIcon::Normal, QIcon::Off);
        stop->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icon/slow.png"), QSize(), QIcon::Normal, QIcon::Off);
        slow->setIcon(icon8);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icon/play.png"), QSize(), QIcon::Normal, QIcon::Off);
        play->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icon/speed.png"), QSize(), QIcon::Normal, QIcon::Off);
        speed->setIcon(icon10);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icon/record.png"), QSize(), QIcon::Normal, QIcon::Off);
        record->setIcon(icon11);
        ...
        menuFilter = new QMenu(menuEffect);
        menuFilter->setObjectName(QString::fromUtf8("menuFilter"));
        menuChangeFactor = new QMenu(menuEffect);
        menuChangeFactor->setObjectName(QString::fromUtf8("menuChangeFactor"));
        ...
        menuEffect->addAction(menuChangeFactor->menuAction());
        menuEffect->addAction(menuFilter->menuAction());
        menuEffect->addAction(actionPlayback);
        menuEffect->addSeparator();
        menuEffect->addAction(actionCut_2);
        menuFilter->addSeparator();
        menuFilter->addAction(actionHighPass);
        menuFilter->addAction(actionLowPass);
        menuFilter->addAction(actionBandPass);
        menuFilter->addAction(actionNotch);
        menuFilter->addAction(actionPeaking);
        menuFilter->addAction(actionLowShelf);
        menuFilter->addAction(actionHighShelf);
        menuChangeFactor->addAction(actionRate);
        menuChangeFactor->addAction(actionPitch);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionHighPass->setText(QApplication::translate("MainWindow", "HighPass", nullptr));
        actionLowPass->setText(QApplication::translate("MainWindow", "LowPass", nullptr));
        actionBandPass->setText(QApplication::translate("MainWindow", "BandPass", nullptr));
        actionNotch->setText(QApplication::translate("MainWindow", "Notch", nullptr));
        actionPeaking->setText(QApplication::translate("MainWindow", "Peaking", nullptr));
        actionLowShelf->setText(QApplication::translate("MainWindow", "LowShelf", nullptr));
        actionHighShelf->setText(QApplication::translate("MainWindow", "HighShelf", nullptr));
        actionRate->setText(QApplication::translate("MainWindow", "Rate", nullptr));
        actionPitch->setText(QApplication::translate("MainWindow", "Pitch", nullptr));
        actionPlayback->setText(QApplication::translate("MainWindow", "Playback", nullptr));
        actionCut_2->setText(QApplication::translate("MainWindow", "Cut", nullptr));
        ...
        menuChangeFactor->setTitle(QApplication::translate("MainWindow", "ChangeFactor", nullptr));
    } // retranslateUi
